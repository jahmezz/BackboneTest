...
(function ($) {
	...
	var ItemView = Backbone.View.extend({
		...
		initialize: function () {
			_.bindAll(this, 'render', 'unrender', 'swap', 'remove'); //bind this to them
	...
	var ListView = Backbone.View.extend({
		...
		initialize: function () {
			...
			this.collection.bind('add', this.appendItem); //call appendItem when add called
